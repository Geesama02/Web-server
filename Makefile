...
%.o: %.cpp Parser/Parser.hpp Config/Config.hpp Config/Location.hpp Config/Server.hpp Request/Request.hpp Request/UploadFile.hpp Response/Response.hpp Cgi/Cgi.hpp Client/Client.hpp
	${CPP} ${FLAGS} -c $< -o $@
